...
game::KubeCombination::KubeCombination(int xStartPoint,int zStartPoint, Colour iBeginn)
{
    ...
    case(0):
    {
        buildLBRICK(choosenColour);
        break;
    }
    case(1):
    {
        buildTBRICK(choosenColour);
        break;
    }
    case(2):
    {
        buildSBRICK(choosenColour);
        break;
    }
    case(3):
    {
        buildZBRICK(choosenColour);
        break;
    }
    case(4):
    {
        buildIBRICK(choosenColour);
        break;
    }
    case(5):
    {
        buildOBRICK(choosenColour);
        break;
    }
    default:
    {
        printf("Unspecified Brick detected!");
    }
    }
